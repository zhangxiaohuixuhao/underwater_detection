...
if __name__ == '__main__':
    args = parse_args()
    test_json_raw = json.load(open("/DATA/zhanghui/underwater-obj_de/data/train/annotations/testA.json", "r"))
    test_json = json.load(open('/DATA/zhanghui/underwater-obj_de/results/testB-2.bbox.json', "r"))
    submit_file_name = 'testB-2.csv'
    submit_path = '/DATA/zhanghui/underwater-obj_de/submit/'
