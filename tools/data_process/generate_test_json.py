...
import sys
sys.path.append('/DATA/zhanghui/underwater-objection-detection/mmdet/')
...
def save(images, annotations):
    ...
    json.dump(ann, open('/DATA/zhanghui/underwater-obj_de/data/train/annotations/testA.json', 'w'))
...
if __name__ == '__main__':
    test_dir = '/DATA/zhanghui/underwater-obj_de/test-B-image/'
